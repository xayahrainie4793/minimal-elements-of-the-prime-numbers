...
The Cunningham numbers *b*<sup>*n*</sup>±1 has algebraic factorization to product of *Φ*<sub>*d*</sub>(*b*) with positive integers *d* dividing *n*, where *Φ* is the cyclotomic polynomial (https://en.wikipedia.org/wiki/Cyclotomic_polynomial, https://mathworld.wolfram.com/CyclotomicPolynomial.html) (see https://stdkmd.net/nrr/repunit/repunitnote.htm)
